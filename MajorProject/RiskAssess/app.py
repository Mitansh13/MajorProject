...
classifier = pickle.load(open('D:\MajorProject\RiskAssess\diabetes-prediction-rfc-model.pkl', 'rb'))
model = pickle.load(open('D:\MajorProject\RiskAssess\model.pkl', 'rb'))
model1 = pickle.load(open('D:\MajorProject\RiskAssess\model1.pkl', 'rb'))
